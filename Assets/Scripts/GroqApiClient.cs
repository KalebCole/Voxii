...
public class Tool
{
    ...
    public Function Function { get; set; } = new Function(); // Initialize with a default value
}
...
public class Function
{
    ...
    public JsonObject Parameters { get; set; } = new JsonObject(); // Initialize with default value
    public Func<string, Task<string>> ExecuteAsync { get; set; } = async (input) => await Task.FromResult(string.Empty); // Initialize with a default Task
}
